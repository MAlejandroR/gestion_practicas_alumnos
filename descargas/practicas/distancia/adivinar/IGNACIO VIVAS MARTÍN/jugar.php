...
<html>
    ...
    <body>
        ...
        if ($cont == 0) {
            ...
            if (isset($_POST["acierto"])) {
                ...
                if ($dato === "menor") {
                    ...
                    echo "¡¡¡¡ENHORABUENA. El número $max es el que estaba pensando!!!!!!";
                }
            }
        }
        ...
        echo "<h1>El número es $max?</h1>";
        echo "<h2>Jugada $cont</h2>";
        ?>
        ...
        <fieldset >
            ...
            <form name="jugar" action="jugar.php?" method="POST">
                ...
                <input type="radio" name="acierto" value="mayor" id="mayor"> Mayor <br />
